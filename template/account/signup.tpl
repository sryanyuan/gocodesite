  ...
  <div class="col-md-6 col-md-offset-3">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form id="id-form-signup" class="simple_form " novalidate="novalidate" id="new_user" action="/signup" accept-charset="UTF-8" method="post">
        ...
        <div id="id-form-submit" class="form-group">
